...
import 'package:elythra_music/core/repository/Spotify/spotify_api.dart';
import 'package:elythra_music/core/repository/Youtube/yt_music_api.dart';
  ...
  static Stream<ImporterState> ytPlaylistImporter(String url) async* {
    ...
    if (playlistID != null) {
      ...
      try {
        ...
        ElythraDBService.createPlaylist(
          playlistMeta.title,
          source: 'youtube',
