...
class ElythraDBService {
  ...
  ElythraDBService get instance => _instance;

  factory ElythraDBService({String? appSuppPath, String? appDocPath}) {
    if (appSuppPath != null) {
      ...
      if (!await dbFile.exists()) {
        for (var element in bPaths) {
          ...
          if (await backUpFile.exists()) {
            ...
            log("DB Restored from $element", name: "ElythraDBService");
            break;
          }
        }
      }
    } catch (e) {
      log("Failed to restore DB", error: e, name: "ElythraDBService");
    }
  }
  ...
  static Future<Isar> openDB() async {
    if (Isar.instanceNames.isEmpty) {
      ...
      if (!await dbFile.exists() &&
        ...
        log("DB Copied to $appSuppDir", name: "ElythraDBService");
        _db.close();
      }
  ...
  static Future<bool> createBackUp() async {
    try {
      ...
      log("Backup created successfully ${backUpFile.path}",
          name: "ElythraDBService");
      return true;
    } catch (e) {
      log("Failed to create backup", error: e, name: "ElythraDBService");
    }
    return false;
  }
  ...
  static Future<bool> backupExists() async {
    try {
      ...
      log("No backup exists", error: e, name: "ElythraDBService");
    }
    return false;
  }
  ...
  static Future<bool> restoreDB() async {
    try {
      ...
      if (await dbFile.exists()) {
        ...
        log("Successfully restored", name: "ElythraDBService");
        ElythraDBService();
        return true;
      }
    } catch (e) {
      log("Restoring DB failed", error: e, name: "ElythraDBService");
    }
    ElythraDBService();
    return false;
  }
