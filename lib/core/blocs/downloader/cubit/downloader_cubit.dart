...
import 'package:elythra_music/core/utils/downloader.dart';
...
class DownloaderCubit extends Cubit<DownloaderState> {
    ...
    receivePort.listen((dynamic data) async {
      ...
      if (_task != null) {
        if (status == DownloadTaskStatus.complete.index) {
          ...
          //     await ElythraDownloader.songTagger(_task!.song,
          ...
          // }
          ElythraDBService.putDownloadDB(
  ...
  Future<void> downloadSong(MediaItemModel song) async {
    ...
    if (isInitialized &&
      ...
      fileName = await ElythraDownloader.getValidFileName(fileName, downPath);
      log('downloading $fileName', name: "DownloaderCubit");
      final String? taskId = await ElythraDownloader.downloadSong(song,
