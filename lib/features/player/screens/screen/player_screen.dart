...
import 'package:elythra_music/features/player/screens/widgets/like_widget.dart';
...
class _AudioPlayerViewState extends State<AudioPlayerView>
  ...
  void initState() {
    ...
    _tabController.addListener(() {
      ...
      final bloomeePlayerCubit = context.read<ElythraPlayerCubit>();
    ...
    _showLyricsSub =
        BlocProvider.of<ElythraPlayerCubit>(context).stream.listen((state) {
      if (mounted) {
        if (state.showLyrics) {
...
class PlayerCtrlWidgets extends StatelessWidget {
  ...
  final BloomeePlayer musicPlayer;
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Tooltip(
                      message: "Lyrics",
                      child:
                          BlocBuilder<ElythraPlayerCubit, ElythraPlayerState>(
                        builder: (context, state) {
                          return Padding(
                ...
                Tooltip(
                  ...
                  child: IconButton(
                    ...
                    icon: StreamBuilder<ElythraMediaItem?>(
                        stream: bloomeePlayerCubit.bloomeePlayer.mediaItem,
                        builder: (context, snapshot) {
                          if (snapshot.hasData &&
...
class AmbientImgShadowWidget extends StatefulWidget {
  final AsyncSnapshot<ElythraMediaItem?> snapshot;
