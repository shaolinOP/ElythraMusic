...
import 'package:elythra_music/features/player/screens/widgets/album_card.dart';
import 'package:elythra_music/features/player/screens/widgets/artist_card.dart';
import 'package:elythra_music/features/player/screens/widgets/more_bottom_sheet.dart';
import 'package:elythra_music/features/player/screens/widgets/playlist_card.dart';
...
import 'package:elythra_music/features/player/screens/screen/search_views/search_page.dart';
...
class SearchScreen extends StatefulWidget {
  ...
  @override
  State<SearchScreen> createState() => SearchScreenStateState();
}

class SearchScreenStateState extends State<SearchScreen> {
  ...
  void loadMoreResults() {
    if (_scrollController.position.pixels ==
        ...
        _sourceEngine == SourceEngine.engJis &&
                ...
                child: InkWell(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        fillColor:
                            DefaultTheme.primaryColor2.withValues(alpha: 0.07),
                        contentPadding:
                            const EdgeInsets.only(top: 20, left: 15, right: 5),
                        hintText: "Find your next song obsession...",
                        hintStyle: TextStyle(
                          color: DefaultTheme.primaryColor1.withValues(alpha: 0.3),
                          fontFamily: "Unageo",
